            ...
            <section className="bg-gray-100">
                ...
                <div className="container mx-auto px-8 pb-10">
                    ...
                    <ul className="list-none list-inside text-black text-md mt-2">
                        <li className="mt-2"><a href="https://www.facebook.com/settings/?tab=ads" className="text-blue-500" rel="noopener noreferrer" target="_blank">FACEBOOK</a></li>
                        <li className="mt-2"><a href="https://www.google.com/settings/ads/anonymous" className="text-blue-500" rel="noopener noreferrer" target="_blank">GOOGLE</a></li>
                        <li className="mt-2"><a href="https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads" className="text-blue-500" rel="noopener noreferrer" target="_blank">BING</a></li>
                    </ul>
                    <p className="text-black text-md mt-8">
