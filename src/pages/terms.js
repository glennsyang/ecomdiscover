...
export default () => {
  ...
  const subtitle = `We offer you the web sites, applications, services and content on ${website} (“${title}”) on the condition that you agree to the following terms.`
    ...
    <Layout>
      ...
      <section className="bg-gray-100">
        ...
        <div className="container mx-auto px-8 pb-10">
          ...
          <p className="text-gray-500 text-base italic mt-6">Last Updated: December 18, 2020</p>
        </div>
      </section>
    </Layout>
  )
