...
export default () => {
  ...
  const subtitle = "A collection of ecommerce resources primarily related to FBA, but also touching on many other aspects of ecommerce software and resources."
