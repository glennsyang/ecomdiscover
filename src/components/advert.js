...
export default function Advert() {
    ...
    return (
        <div className="flex flex-col justify-around mx-4 lg:mx-auto border border-gray-300 rounded-lg shadow-lg p-6 md:ml-4 items-center advert-image">
            <Link to={'/contact'}>
                <SVGImage name="logo" width="100%" height="100%" viewBox="0 0 1450 400" className="h-20 object-none border border-blue-500 bg-white rounded-lg shadow-2xl mx-auto px-4 py-1" />
            </Link>
